...
$tlCfg->reports_list['list_tc_not_applicable'] = array(
'title' => 'link_report_not_applicable_tcs',
'url' => 'lib/results/resultsByStatus.php?type=' . $tlCfg->results['status_code']['not_applicable'],
